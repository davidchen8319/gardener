...
var (
	...
	ControllerWorkerSum = gardenmetrics.NewMetricDescriptor("garden_cm_worker_amount", "Count of currently running controller workers")

	// ScrapeFailures is a metric descriptor which counts the amount scrape issues grouped by kind.
	ScrapeFailures = gardenmetrics.NewCounterVec("garden_scrape_failure_total", "Total count of scraping failures, grouped by kind/group of metric(s)")
)
